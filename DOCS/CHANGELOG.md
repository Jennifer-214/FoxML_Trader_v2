...
|---------|------|------------|
| 3.6.1 | 2026-04-02 | **Exit buffer equity fix + fee floor enforcement** — Kill switch false triggers from exit buffer timing gap (exact pending proceeds). Win/loss classification by P&L sign (fee-dominated TP exits count as losses). Fee floor enforced after all regime TP tightening (prevents money-losing "wins"). 271 assertions. |
