...
|---------|------|------------|
| 3.2.0 | 2026-03-28 | **v4 signals + refactor** — VWAP gate, session awareness, adaptive cooldown, partial exits, L2 order book, Gate_Zero helper, table-driven config, bulk hot-reload, remove FTXUI/notcurses (-1009 net lines) |
