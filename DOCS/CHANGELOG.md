...
|---------|------|------------|
| 3.1.0 | 2026-03-27 | **Profitability + latency overhaul** — volume delta signal, hidden downtrend detection, min vol filter, momentum R² floor, cache-aligned structs, -O3 -march=native, BuyGate 102→53ns, p95 4069→936ns, slow 102→33μs |
