...
//                    e.g., `h->inference_cfg_confidence_threshold_scale`
...
#define FOREACH_CFG_DRIFT_CHECK(X)                                                                                                                                                                                                                                              \
    ...
    X(barrier_gate_enabled,                  int,      REFUSE_STRICT,  INFERENCE_CFG,   EXACT,                                                                                                                                                                                   \
      h->inference_cfg_barrier_gate_enabled, (BITMAP_IS_SET(cfg.gate_cfg_flags, MASK_GATE_CFG_BARRIER_GATE_ENABLED) ? 1 : 0),                                                                                                                                                    \
      STAMP_HAS(*h, inference_cfg),          FAILURE_MASK_cfg_binding_drift,                                                                                                                                                                                                     \
    ...
    X(confidence_hard_block_threshold,       double,   WARN_ALWAYS,    INFERENCE_CFG,   EPS_DEFAULT,                                                                                                                                                                             \
      h->inference_cfg_confidence_hard_block_threshold, FPN_ToDouble(cfg.confidence_hard_block_threshold),                                                                                                                                                                       \
      STAMP_HAS(*h, inference_cfg),          FAILURE_MASK_cfg_binding_drift,                                                                                                                                                                                                     \
    ...
    X(bandit_blend_ratio,                    double,   WARN_ALWAYS,    INFERENCE_CFG,   EPS_DEFAULT,                                                                                                                                                                             \
      ...
      (STAMP_HAS(*h, inference_cfg_bandit_blend_ratio) && BITMAP_IS_SET(cfg.ml_cfg_flags, MASK_ML_CFG_BANDIT_ENABLED)), FAILURE_MASK_cfg_binding_drift,                                                                                                                          \
      "Tier 2 bandit_blend_ratio drift (gated by bandit_enabled; WARN)")                                                                                                                                                                                                         \
    ...
    /* Per § C.3 of merged plan body. Gate uses group bit STAMP_HAS(*h, inference_cfg) since per-field STAMP_BIT_inference_cfg_X don't exist (only group bit per .A.7 precedent). */ \
    X(bandit_algorithm,                      int,      WARN_ALWAYS,    INFERENCE_CFG,   EXACT,                                                                                                                                                                                   \
      h->inference_cfg_bandit_algorithm,     cfg.bandit_algorithm,                                                                                                                                                                                                               \
      (STAMP_HAS(*h, inference_cfg) && BITMAP_IS_SET(cfg.ml_cfg_flags, MASK_ML_CFG_BANDIT_ENABLED)), FAILURE_MASK_cfg_binding_drift,                                                                                                                                            \
      "Tier 2 bandit_algorithm enum drift (WARN to avoid false-positive on legacy cfg=2 stamps post-.F.4d Option C semantic flip; gate: group bit + master bandit-enable flag)")                                                                                                 \
    ...
    X(thompson_exp3_blend_alpha,             double,   REFUSE_STRICT,  INFERENCE_CFG,   EPS_DEFAULT,                                                                                                                                                                             \
      ...
      (STAMP_HAS(*h, inference_cfg) && (cfg.bandit_algorithm == 4)), FAILURE_MASK_cfg_binding_drift,                                                                                                                                                                            \
    ...
    X(fee_rate_maker,                        double,   WARN_ALWAYS,    INFERENCE_CFG,   EPS_DEFAULT,                                                                                                                                                                             \
      h->inference_cfg_fee_rate_maker,       FPN_ToDouble(cfg.fee_rate_maker),                                                                                                                                                                                                   \
      (STAMP_HAS(*h, fees) && BITMAP_IS_SET(cfg.gate_cfg_flags, MASK_GATE_CFG_COST_GATE_ENABLED)), FAILURE_MASK_cfg_binding_drift,                                                                                                                                               \
      "Tier 2 fee_rate_maker drift (gated by cost_gate_enabled; WARN)")                                                                                                                                                                                                          \
    X(fee_rate_taker,                        double,   WARN_ALWAYS,    INFERENCE_CFG,   EPS_DEFAULT,                                                                                                                                                                             \
      h->inference_cfg_fee_rate_taker,       FPN_ToDouble(cfg.fee_rate_taker),                                                                                                                                                                                                   \
      (STAMP_HAS(*h, fees) && BITMAP_IS_SET(cfg.gate_cfg_flags, MASK_GATE_CFG_COST_GATE_ENABLED)), FAILURE_MASK_cfg_binding_drift,                                                                                                                                               \
      "Tier 2 fee_rate_taker drift (gated by cost_gate_enabled; WARN)")                                                                                                                                                                                                          \
    ...
    X(ml_tp_pct,                             double,   REFUSE_STRICT,  INFERENCE_CFG,   EPS_DEFAULT,                                                                                                                                                                             \
      h->inference_cfg_ml_tp_pct,            FPN_ToDouble(cfg.ml_tp_pct),                                                                                                                                                                                                        \
      (STAMP_HAS(*h, inference_cfg) && BITMAP_IS_SET(cfg.ml_cfg_flags, MASK_ML_CFG_PER_HORIZON_BARRIER_BLEND)), FAILURE_MASK_cfg_binding_drift,                                                                                                                                  \
    ...
    X(ml_sl_pct,                             double,   REFUSE_STRICT,  INFERENCE_CFG,   EPS_DEFAULT,                                                                                                                                                                             \
      h->inference_cfg_ml_sl_pct,            FPN_ToDouble(cfg.ml_sl_pct),                                                                                                                                                                                                        \
      (STAMP_HAS(*h, inference_cfg) && BITMAP_IS_SET(cfg.ml_cfg_flags, MASK_ML_CFG_PER_HORIZON_BARRIER_BLEND)), FAILURE_MASK_cfg_binding_drift,                                                                                                                                  \
    ...
    X(barrier_blend_mode,                    int,      REFUSE_STRICT,  INFERENCE_CFG,   EXACT,                                                                                                                                                                                   \
      h->inference_cfg_barrier_blend_mode,   cfg.barrier_blend_mode,                                                                                                                                                                                                             \
      (STAMP_HAS(*h, inference_cfg) && BITMAP_IS_SET(cfg.ml_cfg_flags, MASK_ML_CFG_PER_HORIZON_BARRIER_BLEND)), FAILURE_MASK_cfg_binding_drift,                                                                                                                                  \
    ...
    X(per_horizon_barrier_blend,             int,      REFUSE_STRICT,  INFERENCE_CFG,   EXACT,                                                                                                                                                                                   \
      h->inference_cfg_per_horizon_barrier_blend, (BITMAP_IS_SET(cfg.ml_cfg_flags, MASK_ML_CFG_PER_HORIZON_BARRIER_BLEND) ? 1 : 0),                                                                                                                                              \
      STAMP_HAS(*h, inference_cfg), FAILURE_MASK_cfg_binding_drift,                                                                                                                                                                                                              \
