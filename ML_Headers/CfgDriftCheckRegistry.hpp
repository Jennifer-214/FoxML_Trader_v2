...
#define FOREACH_CFG_DRIFT_CHECK(X)                                                                                                                                                                                                                                              \
    ...
    /* HISTORICAL (superseded Step 6.10; kept for context — only per_horizon_barrier_blend still  */                                                                                                                                                                                  \
    /* gates on STAMP_HAS(*h, inference_cfg) — a bit production emit never sets: PARITY-042). */                                                                                                                                                                                  \
