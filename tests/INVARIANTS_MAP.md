...
| 12 | **Held-Out Validation Discipline** (token-locked, single eval, gap < threshold) | Phase 7prep: HeldOutSplit math (3501), Lock-token discipline (3529), RunFullValidation framework (3558) | COVERED |
...
- **17 COVERED** (78%) — direct test failure on regression
- **4 DISCIPLINE** (#5, #18, #19, #20) — structural invariants enforced by code
  layout / thread topology, verified via parity_harness + sanitizers
