...
// [SCHEMA]_[v1.0]
// [OVERVIEW]_[LEGACY centralized controller — single_core mode + controller_test ONLY (sharded production uses the OMS path); tick loop + strategy dispatch + kill switch. Its v14 snapshot format RETIRED at E.1.2/D-289 (serializers deleted; CONTROLLER_SNAPSHOT_VERSION=14 tombstoned in git history — H21: the number is burned, never reuse)]
// [CONTAINS]
